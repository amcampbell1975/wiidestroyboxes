...
#include "hello_wav.h"   // generated by bin2
...
int main(int argc, char **argv) {
    ...
    // Play the embedded WAV
    // ASND_SetVoice(0, VOICE_STEREO_16BIT, 44100, 0,
    //               hello_wav, hello_wav_size, 255, 255, NULL);
    ASND_SetVoice(
    0,
    VOICE_MONO_8BIT,   // <‑‑ correct format for 8‑bit mono
    22050,
    0,
    (void*)hello_wav,   // <-- cast removes warning safely
    hello_wav_size,
    255,
    255,
    NULL
